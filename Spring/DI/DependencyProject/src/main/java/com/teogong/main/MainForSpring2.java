...
import com.teogong.config.AppConf1;
import com.teogong.config.AppConf2;
import com.teogong.exception.DuplicateMemberException;
import com.teogong.exception.MemberNotFoundException;
import com.teogong.exception.WrongIdPasswordException;
...
import com.teogong.service.RegisterRequest;
...
public class MainForSpring2 {
	...
	public static void main(String[] args) throws Exception {
		// IoC(Inversion of control) 프레임웍에다가 넘겨버림
	...
	private static void processNewCommand(String[] arg) {
		...
		MemberRegisterService regSvc = ctx.getBean("memberRegSvs", MemberRegisterService.class);
	...
	private static void processInfoCommand(String[] arg) {
		...
		MemberInforPrinter infoPrinter = ctx.getBean("infoPrinter", MemberInforPrinter.class);
